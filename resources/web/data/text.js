var LangText = {
  ...
  pl_PL: {
    t1: "Witamy w Orca SlicerRED",
    t2: "Slicer zostanie skonfigurowany w kilku krokach. Zacznijmy!",
    ...
    t83: "2, Zamknij wszystkie otwarte Orca SlicerRED",
    t84: "3, Usuń wszystkie pliki z katalogu wtyczek",
    t85: "4, Ponownie otwórz Orca SlicerRED i zainstaluj wtyczkę ponownie",
    t86: "Zamknij",
    ...
    t98: "Nazwa modelu",
    t100: "Opis modelu",
    t101: "Przydatne linki",
    t102: "Przewodnik montażu",
    t103: "Inne",
    t104: "Nazwa projektu",
    t105: "Autor projektu",
    t106: "Opis projektu",
    t107: "Modele online MakerWorld ",
    ...
    wk1: "Szybki start",
    wk2: "Ten artykuł przedstawia najbardziej podstawowe wykorzystanie Orca Slicer. Przewodnik dla użytkowników w konfiguracji oprogramowania, tworzeniu projektów i przeprowadzeniu pierwszego zadania drukowania krok po kroku.",
    wk3: "Przepływ pracy oparty na projektach",
    wk4: "Orca Slicer wykorzystuje zaawansowany przepływ pracy do realizacji projektu „wszystko w jednym”. Bazując na popularnym formacie projektu 3MF, dostarcza szereg nowatorskich funkcji, takich jak obsługa wielu płyt, menedżer zasobów projektu oraz widok montażu/części. To znacznie zwiększa efektywność twórców i regularnych użytkowników",
    wk5: "Drukowanie w wysokiej jakości i z dużą prędkością",
    wk6: "Trudno jest drukować z dużą prędkością, zachowując przy tym wysoką jakość. Orca Slicer umożliwia to. „Arch Move” pozwala na płynne poruszanie się głowicy i redukuje wibracje maszyny. Inteligentne chłodzenie oparte na dostosowanych parametrach chłodzenia dla każdego rodzaju filamentu. „Automatyczne zwalnianie” dla ścianek wychodzących poza obrys pozwala uniknąć deformacji przy wysokiej prędkości.",
    wk7: "Drukowanie wielokolorowe",
    wk8: "Orca Slicer oferuje wszechstronne narzędzia do kolorowania w celu tworzenia kolorowego modelu. Możesz swobodnie dodawać/usuwać filamenty w projekcie i kolorować swój model za pomocą różnych pędzli. Przed drukowaniem każdy filament zostanie automatycznie odwzorowany na pozycję AMS, bez konieczności ręcznej modyfikacji rozmieszczenia cewki w AMS.",
    wk9: "Przewodnik po ustawieniach wycięcia",
    wk10: "Funkcje zarządzania ustawieniami Orca Slicer zapewniają bardzo elastyczną i potężną kontrolę nad procesem wycięcia. W tym artykule przedstawiamy organizację ustawień i udostępniamy kilka wskazówek, aby w pełni wykorzystać te funkcje.",
    wk11: "Zdalne sterowanie i monitorowanie",
    wk12: "Orca Slicer obsługuje wysyłanie pracy drukowania do drukarki przez sieć WAN/LAN, kontrolując i monitorując każdy aspekt drukarki 3D oraz prac drukowania. Jeśli masz kilka drukarek, łatwo możesz przełączać się między nimi na liście urządzeń.",
    wk13: "Format STEP",
    ...
    wk15: "Tekst 3D",
    wk16: "Dzięki narzędziu Tekst 3D użytkownicy mogą łatwo tworzyć różne kształty tekstu 3D w projekcie, co sprawia, że model staje się bardziej spersonalizowany. Orca Slicer dostarcza dziesiątki czcionek i obsługuje style pogrubienia i kursywy, aby nadać tekstu większą elastyczność.",
  },
};
